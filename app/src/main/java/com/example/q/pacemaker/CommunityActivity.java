...
public class CommunityActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
        LocationListener, GoogleApiClient.OnConnectionFailedListener, GoogleMap.OnMapClickListener,
        OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.community_map_fragment);
        ...
        try {
            ...
            if (res != null && res.has("result") && res.getString("result").equals("success")) {
                ...
                latitude = goal.getString("latitude");
                longitude = goal.getString("longitude");
            }
        }catch (JSONException | InterruptedException | ExecutionException e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            JSONObject res = new SendJSON(App.server_url + App.routing_get_clone_list, req.toString(), App.JSONcontentsType).execute().get();
            LatLngArray = new JSONArray();
            if (res != null && res.has("result") && res.getString("result").equals("success")) {
                JSONArray clones = res.getJSONArray("clones");
    ...
    public void onMapReady(GoogleMap map) {
        ...
        googleMap.setOnMapClickListener(CommunityActivity.this);
    ...
    public void onMapClick(LatLng point) {
        ...
        selectLocationIntent.putExtra("latlng", LatLngArray.toString());
        ...
        switch (requestCode) {
            ...
            case  REQUEST_CODE_GPS:
                ...
                if ( locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER))
                {
                    ...
                    setGPS = true;
                    mapFragment.getMapAsync(CommunityActivity.this);
                }

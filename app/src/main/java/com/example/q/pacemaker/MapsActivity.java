...
public class MapsActivity extends FragmentActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    MarkerOptions selectedLocation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectButton = (Button) findViewById(R.id.map_select_button);
        selectButton.setTypeface(App.NanumBarunGothic);
        selectButton.setOnClickListener(selectButtonOnClicked);
